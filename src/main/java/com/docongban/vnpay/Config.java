...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8088/vnpay_return";
    ...
    public static String hashAllFields(Map fields) {
        ...
        return hmacSHA512(com.docongban.vnpay.Config.vnp_HashSecret, sb.toString());
    }
